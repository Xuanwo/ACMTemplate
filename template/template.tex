...
\title{{TopIdiots队的ACM模板}}
\author{CUGBACM TopIdiots}
...
\DefineVerbatimEnvironment{Highlighting}{Verbatim}{frame=leftline,numbers=left,numbersep=2pt,commandchars=\\\{\},frame=leftline,fontsize=\small}
